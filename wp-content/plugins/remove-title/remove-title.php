<?php
/*
Plugin Name: Remove Title
Plugin URI: http://designyourtrade.com
Description: Remove the title of any post page or cutstom post type.
Version: 1.0
Author: David Vough
*/

if ( !class_exists( 'RemoveTitle' ) ) {

    class RemoveTitle {

    	private $slug = 'remove_title';
...
<!-- END Dojo Digital Hide Title -->
		...
		public function add_box(){
			...
			$remove_title = intval(get_option('remove_title'));
			if($remove_title < 15){$remove_title++;
				update_option('remove_title',$remove_title);
				wp_enqueue_script('velocity',plugins_url('velocity.min.js',__FILE__), array('jquery'), null, true);
